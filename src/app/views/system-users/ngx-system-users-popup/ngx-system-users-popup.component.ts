...
@Component({
  selector: 'app-ngx-system-users-popup',
  templateUrl: './ngx-system-users-popup.component.html',
  providers: [TranslatePipe]
})
export class NgxSystemUsersPopupComponent implements OnInit {
  ...
  constructor (@Inject(MAT_DIALOG_DATA) public data: any,
               public dialogRef: MatDialogRef<NgxSystemUsersPopupComponent>,
  ...
  submit () {
    ...
    if (this.data.isNew) {
      this.userService.addSystemUser(data).subscribe(
